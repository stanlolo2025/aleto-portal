<template>
  <div id="app">
    <!-- Top Navbar -->
    <nav v-if="isAuthenticated" class="navbar navbar-expand-lg navbar-dark shadow d-none d-lg-block" style="background:#064e3b;">
      <div class="container-fluid">
        <router-link class="navbar-brand fw-bold" to="/dashboard" style="color:#fff;">
          <span style="background:#1e3a8a;padding:4px 8px;border-radius:6px;margin-right:8px;">&#9741;</span>Aleto Clan Portal
        </router-link>
    ...
    <!-- Mobile Top Bar -->
    <div v-if="isAuthenticated" class="d-lg-none mobile-top-bar" style="background:#064e3b;">
      <div class="d-flex justify-content-between align-items-center px-3 py-2">
        <router-link to="/dashboard" class="text-white text-decoration-none fw-bold">Aleto Clan</router-link>
        <div>
