...
<footer class="bg-secondary text-white pt-16 pb-8">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
      ...
      <div><h4 class="text-lg font-bold mb-6">Contact</h4><ul class="space-y-3 text-secondary-foreground/70 text-sm"><li class="flex gap-2"><iconify-icon icon="lucide:map-pin" class="text-tertiary text-lg flex-shrink-0"></iconify-icon><span>Aleto Clan Community Hall, Eleme, Rivers State</span></li><li class="flex gap-2"><iconify-icon icon="lucide:phone" class="text-tertiary text-lg flex-shrink-0"></iconify-icon><span>+234 800 000 0000</span></li><li class="flex gap-2"><iconify-icon icon="lucide:mail" class="text-tertiary text-lg flex-shrink-0"></iconify-icon><span>info@aletoclan.com</span></li></ul></div>
